...
class Theme(ft.UserControl):
    ...
    async def switch_theme(self, e):
        ...
        self.page.controls[0].controls[0].content.controls[0].controls[0].src = r'app\assets\images\black_background.gif' if self.page.theme_mode == ft.ThemeMode.DARK else r'app\assets\images\white_background.gif'
