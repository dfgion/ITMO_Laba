...
class SignInText(ft.UserControl):
    ...
    def build(self):
        return ft.Container(content=ft.Text(value='Sign in',
...
class Code(ft.UserControl):
    ...
    async def animate(self, e):
        e.control.content.hint_text = 'Type code from bot' if e.control.width == 180 else None
        e.control.width = 260 if e.control.width == 180 else 180
        e.control.margin = ft.margin.only(left=10) if e.control.margin == ft.margin.only(left=50) else ft.margin.only(left=50)
        await self.update_async()
    ...
    def build(self):
        return ft.Container(content=ft.TextField(label='Code',
                                                 label_style=ft.TextStyle(font_family=r'app\assets\fonts\ocra.ttf',
                                                                          weight='BOLD',
                                                                          color='white',
                                                                          size=20),
...
class Hint(ft.UserControl):
    ...
    def build(self):
        return ft.Container(content=ft.TextField(label='',
                                                 label_style=ft.TextStyle(font_family=r'app\assets\fonts\ocra.ttf',
                                                                          weight='BOLD',
                                                                          color='white',
                                                                          size=20),
                                                 ...
                                                 hint_text='',
                                                 hint_style=ft.TextStyle(font_family=r'app\assets\fonts\ocra.ttf',
                                                                          weight='BOLD',   
                                                                          color='BLUE_100',                     
                                                                          size=20),
...
class QR(ft.UserControl):
    def build(self):
        return ft.Container(content=ft.Image(src=r'app\assets\images\white_qr.png',
                                                      width=150,
                                                      height=150,
                                                      ),
                                     alignment=ft.Alignment(0, 0),
...
class BlackPanel(ft.UserControl):
    ...
    def build(self):
        return ft.Container(content=ft.Column(controls=[
                            ...
                            height = 450,
                            border_radius=20,
                            border=ft.Border(top=ft.BorderSide(width=10, color='grey'),
...
class ITMOImage(ft.UserControl):
    def build(self):
        return ft.Image(src=r'app\assets\images\label.png',
                        width=300,
                        height=120,
                        )
...
class BackgroundImage(ft.UserControl):
    def build(self):
        return ft.Image(src=r'app\assets\images\background_image.gif',
                        width=700, 
                        height=900,
                        fit='fill',
                        )
